...
- [브로드캐스트 그룹](/ko-KR/channels/broadcast-groups) - 멀티 에이전트 동시 처리
- [채널 문제 해결](/ko-KR/channels/troubleshooting) - 채널별 문제 진단과 해결
...
- [프레즌스](/ko-KR/concepts/presence) - 온라인 상태 관리
...
- [Thinking 모드](/ko-KR/tools/thinking) - 추론 수준과 토큰 예산
- [LLM Task](/ko-KR/tools/llm-task) - 에이전트 내 LLM 서브태스크
- [Agent Send](/ko-KR/tools/agent-send) - CLI에서 에이전트에 메시지 전송
- [멀티 에이전트 샌드박스](/ko-KR/tools/multi-agent-sandbox-tools) - 도구 접근 제어

### 웹 인터페이스

- [웹 인터페이스](/ko-KR/web) - Control UI, Dashboard, WebChat
- [대시보드](/ko-KR/web/dashboard) - Gateway 대시보드 접근과 인증
...
- [크론 vs 하트비트](/ko-KR/automation/cron-vs-heartbeat) - 스케줄링 방법 선택 가이드
...
- [환경 변수](/ko-KR/help/environment) - 환경 변수 로딩과 우선순위
- [테스팅](/ko-KR/help/testing) - 단위/E2E/라이브 테스트 스위트
